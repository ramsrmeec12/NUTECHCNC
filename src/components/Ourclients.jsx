...
const clients = [
  { id: 1, img: client1, desc: 'Bon' },
  { id: 2, img: client2, desc: 'Apollo Tyres' },
  { id: 3, img: client3, desc: 'Cycle Agarbattis' },
  { id: 4, img: client4, desc: 'Brandon' },
  { id: 5, img: client5, desc: 'Primacy' },
  { id: 6, img: client6, desc: 'K2 Footprints' },
  { id: 7, img: client7, desc: 'BBK Electronics' },
  { id: 8, img: client8, desc: 'PRIMO SHOES' },
  { id: 9, img: client9, desc: 'Sai Corporation' },
  { id: 10, img: client10, desc: 'OLG' },
  { id: 11, img: client11, desc: 'AMUSE' },
